...
/datum/category_item/player_setup_item/vore/misc/content(var/mob/user)
	...
	*/
	. += span_bold("Режим датчиков одежды:") + " <a [pref.sensorpref ? "" : ""] href='?src=\ref[src];toggle_sensor_setting=1'><b>[sensorpreflist[pref.sensorpref]]</b></a><br>"
	. += span_bold("Разрешить заключение в кристалл:") + " <a [pref.capture_crystal ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_capture_crystal=1'><b>[pref.capture_crystal ? "Да" : "Нет"]</b></a><br>"
	. += span_bold("Имплантат резервного копирования:") + " <a [pref.auto_backup_implant ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_implant=1'><b>[pref.auto_backup_implant ? "Да" : "Нет"]</b></a><br>"
	...
	. += span_bold("<a [pref.borg_petting ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_borg_petting=1'><b>[pref.borg_petting ? "Допускать" : "Не допускать"]") + "</a> поглаживания, будучи роботом</b><br>"
	. += span_bold("<a [pref.stomach_vision ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_stomach_vision=1'><b>[pref.stomach_vision ? "Отображать" : "Не отображать"]") + "</a> животы персонажей</b><br>"
